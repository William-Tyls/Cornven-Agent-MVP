import type { RawPosImportRequest } from '@cornven/contracts';

/**
 * Mirrors fixtures/pos/mock-sales.json, the shared v0.3 raw POS example.
 * The web TypeScript project only includes src, so it keeps this typed copy.
 */
export const mockPosImport: RawPosImportRequest = {
  ...
  records: [
    {
      ...
      occurredAt: '2026-08-05T02:15:00.000Z',
      quantity: 4,
      unitPrice: '50.00',
      totalAmount: '200.00',
    ...
    },
    {
      ...
      sourceTransactionId: 'TX-EXCHANGE-001',
      parentTransactionId: 'TX-001',
      artistId: 'ART-001',
      artistName: 'Sample Artist',
      venueId: 'VENUE-001',
